    ...
    <html>
        ...
        <body topmargin="0" leftmargin="0" onLoad="MM_preloadImages('');MM_preloadImages('');MM_preloadImages('');MM_preloadImages('')">
            <form name="form_cerrar" action="cerrar_session.php?<?=session_name()."=".session_id()."&fechah=$fechah"?>" target="_parent method=post">
			    ...
			    <DIV style="position: absolute; top: 0px; left: 260px; heigth:36px; width=50px;"><img src=logoEntidad.png width=160></DIV>
                        </td>
                        ...
                        <td width="52"  background="./imagenes/ayuda.gif">
                            <a href="http://orfeogpl.info/wiki/ManualUsFinal" target="Ayuda_Orfeo" />
			...
			<?php
      if ($_SESSION["autentica_por_LDAP"] == 1) $imagen="imagenes/cabezote_r1_c2.gif";  else $imagen="imagenes/contrasena.gif";
