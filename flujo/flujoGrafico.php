...
<table width="100%" border="0">
  <tr>
    ...
    <th scope="col"><table width="90%" class="borde_tab" align="center" >
      <tr>
        <td height="25"  align="center"><a href='#' onclick="Start('./verHistorico.php?verrad=<?=$verrad?>&cmp=<?=$password?>&fechah=<?=$fechah?>',300,400);"> <span class=titulos2>VER HISTORICO DEL DOCUMENTO</span></a></td>
      </tr>
    </table></th>
  </tr>
</table>
