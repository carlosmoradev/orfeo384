...
$encabezado = "krd=$krd&usModo=$usModo&perfil=$perfil&dep_sel=$dep_sel&cedula=$cedula&usuLogin=$usuLogin&nombre=$nombre&dia=$dia&mes=$mes&ano=$ano&ubicacion=$ubicacion&piso=$piso&extension=$extension&&email=$email&email1=$email1&email2=$email2&usuDocSel=$usuDocSel&usuLoginSel=$usuLoginSel";
if ($errorValida == "SI")
{
?>
