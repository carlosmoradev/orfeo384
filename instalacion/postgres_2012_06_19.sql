	...
	-- Dependencies: 6
	-- Name: _matrird; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
	--
	...
	CREATE TABLE sgd_mrd_matrird (
	    ...
	    sgd_srd_id numeric(4,0) NOT NULL DEFAULT 0,
	    sgd_sbrd_id numeric(4,0) NOT NULL DEFAULT 0,
	...
	(
	  ...
	  CONSTRAINT pk_sgd_srd_seriesrd PRIMARY KEY (sgd_srd_codigo),
	  CONSTRAINT uk_sgd_srd_descrip UNIQUE (sgd_srd_descrip)
	);

-- COMMENT ON CONSTRAINT un_srdId ON sgd_srd_seriesrd IS 'Clave unica para codigos de Series.';
...
-- Table: sgd_sbrd_subserierd

-- DROP TABLE sgd_sbrd_subserierd;

CREATE TABLE sgd_sbrd_subserierd
(
  sgd_srd_codigo numeric(4,0) NOT NULL, -- Codigo de Serie Documental, desde la ver 3.8 se elimina el pk en este campo y se crea el Id.  Esto permite la modificacion de este codigo segun conveniencia de las Entidades/Empresas.
  sgd_sbrd_codigo numeric(4,0) NOT NULL,
  sgd_sbrd_descrip character varying(200) NOT NULL,
  sgd_sbrd_fechini timestamp without time zone NOT NULL, -- Fecha en la cual inicia la ejecucion de esta subserie Documental.
  sgd_sbrd_fechfin timestamp without time zone NOT NULL, -- Fecha en la cual finaliza la ejecucion de esta subserie Documental.
...
-- COMMENT ON COLUMN sgd_sbrd_subserierd.sgd_srd_id IS 'Codigo unico de serie Documental (id de sgd_srd_seriesrd)';
...
-- TABLAS DE MODULO DE SOPORTE

CREATE TABLE SGD_TSOP_TIPOSOPORTE
   (    SGD_TSOP_ID NUMERIC(6,0) DEFAULT NULL NOT NULL ,
        SGD_TSOP_DESCR VARCHAR(250) NOT NULL ,
...
-- Table: sgd_sop_soporte

-- DROP TABLE sgd_sop_soporte;
...
(
  ...
  sgd_sop_est numeric(1,0) NOT NULL DEFAULT 0,
  ...
  CONSTRAINT fk_SOP_SOPORTE_FK2 FOREIGN KEY (sgd_tsop_id)
      REFERENCES sgd_tsop_tiposoporte (sgd_tsop_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT sgd_sop_soporte_sgd_sop_id_key UNIQUE (sgd_sop_id)
)
WITH (
  OIDS=FALSE
);
...
-- Table: sgd_csop_coment

-- DROP TABLE sgd_csop_coment;
...
(
  ...
  CONSTRAINT "FK_SOP_SOPORTE" FOREIGN KEY (sgd_sop_id)
      REFERENCES sgd_sop_soporte (sgd_sop_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
...
update usuario set sgd_rol_codigo=1 where usua_codi=1;
update usuario set sgd_rol_codigo=0;
INSERT INTO public.sgd_srd_seriesrd(sgd_srd_codigo, sgd_srd_descrip, sgd_srd_fechini, sgd_srd_fechfin) VALUES (0, 'No Aplica', '2012-06-06', '2020-06-01');


ALTER TABLE usuario ADD COLUMN sgd_rol_codigo numeric(1,0) default 0;
ALTER TABLE sgd_mrd_matrird   add column DEPE_CODI_APLICA  character varying(100);
ALTER TABLE sgd_sexp_secexpedientes ADD COLUMN sgd_exp_caja character varying(10);
ALTER TABLE radicado   add COLUMN depe_codi numeric(6,0);
ALTER TABLE radicado   add COLUMN sgd_trad_codigo numeric(3,0);
ALTER TABLE sgd_eit_items ALTER COLUMN sgd_eit_sigla TYPE character varying(20);
ALTER TABLE radicado ADD COLUMN radi_nume_iden character varying(15);
ALTER TABLE sgd_renv_regenvio   ALTER COLUMN radi_nume_sal TYPE numeric(22,0)
ALTER TABLE sgd_renv_regenvio   ALTER COLUMN sgd_renv_grupo TYPE numeric(22,0);
ALTER TABLE sgd_renv_regenvio   ALTER COLUMN radi_nume_grupo TYPE numeric(22,0);
ALTER TABLE dependencia ADD COLUMN acto_admon character varying(100);
ALTER TABLE sgd_prd_prcdmentos ADD COLUMN sgd_prc_codigo numeric(4,0);
ALTER TABLE radicado   add COLUMN radi_nume_folio numeric(5,0);
ALTER TABLE radicado   add COLUMN radi_nume_anexo varchar(50);
ALTER TABLE radicado   add COLUMN radi_nume_guia varchar(50);
ALTER TABLE radicado   add COLUMN sgd_rad_codigoverificacion varchar(20);
ALTER TABLE radicado   add COLUMN sgd_trad_codigo numeric(3,0);
ALTER TABLE sgd_exp_expediente add COLUMN sgd_prd_codigo numeric(4,0);
