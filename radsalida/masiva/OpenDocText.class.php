...
class OpenDocText {
    ...
    var $workDir = '';	// Directorio de trabajo para descomprimir el ODT ruta abs
    ...
    **/
    ...
    function abrirOdt(){
        ...
        function cargarContenido(){
            ...
            ( $this->debug == true) ? ( $error = "<CENTER><table class=borde_tab><tr>
                <td class=info>Directorio y archivo salida: $directorio </td></tr></table>" ) : $error = '' ;
            echo $error;
            if ($esDir){
                ...
                if ($cambio){
                    ...
                    if(is_file($this->stylesXml)) {
                        ( $this->debug == true) ? ( $error = "Conoce archivo contenido.</br>" ) : $error = '' ;
                        echo $error;
