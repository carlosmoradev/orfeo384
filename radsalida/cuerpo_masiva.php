              ...
              <table BORDER=0  cellpad=2 cellspacing='2' WIDTH=100% class='borde_tab' valign='top' align='center' cellpadding="2" >
                <tr bgcolor="titulos5"> 
                  ...
                  <td width='10%' align="left" class='titulos5'> 
                    <input type=submit value='<?=$accion_sal ?>' name=Enviar valign='middle' class='botones_largo' onclick="return envioTx()">
                  </td>
                </TR>
              </TABLE>
            </td>
			 ...
			 ?>
                <tr class='<?=$formato?>'> 
                  ...
                  <td class='leidos' align="center" width="10%">
                    <a href='lista_sacar_grupo.php?<?=session_name()."=".session_id()?>&grupo=<?=$radi_nume_grupo?>&krd=<?=$krd?>&dep_sel=<?=$dep_sel?>'><span class='leidos'> 
                    <?=$radi_nume_grupo ?>
                    </span></a> </td>
