...
<form method="post" action="<?=$_SERVER['PHP_SELF']?>?nurad=<?=$nurad?>" name="insExpBus">
  <table border=0 width=70% align="center" class="borde_tab" cellspacing="1" cellpadding="0">        
    <tr align="center" class="titulos2">
      <td height="15" class="titulos2" colspan="2">BUSCAR EXPEDIENTE POR ETIQUETAS</td>
    </tr>
  </table>
...
*/
	...
	<td height="15" colspan="2" align="center">EXPEDIENTES QUE COINCIDEN CON DOCUMENTO DE REMITENTE</td>
	</tr>
	</table>
