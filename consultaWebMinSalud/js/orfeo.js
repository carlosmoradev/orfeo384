...
function consultaPQRSSP(){
		...
		if(jQuery('#formularioConsultaWeb').is(":visible")){
			jQuery('#formularioConsultaWeb').hide();
			//document.getElementById('consultaweb').style.visibility = "hidden";
		}
		jQuery('#formularioConsultaPQRSP').show();
}

function consultaWeb(){
	if(jQuery('#formularioConsultaPQRSP').is(":visible")){
		jQuery('#formularioConsultaPQRSP').hide();
		//document.getElementById('consultaPQRSP').style.visibility = "hidden";
	}
	jQuery('#formularioConsultaWeb').show();
}
