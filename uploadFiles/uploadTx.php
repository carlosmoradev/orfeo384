...
$my_upload->extensions = array(".tif", ".pdf",  ".jpg", ".odt", ".html",".docx","xlsx", ".gif",".htm","png",".svg"); // specify the allowed extensions here
...
if(isset($_POST['Realizar'])) {
	...
	$depe_dir += 0;	
	$uploadDir = "$ruta_raiz/bodega/".substr($valRadio,0,4)."/".$depe_dir."/";
	$fileGrb = substr($valRadio,0,4)."/".$depe_dir."/$valRadio".".".substr($tmpFile,-3);
